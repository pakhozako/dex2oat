/* Dex2oat Lock v3.5 protected bundle. Built from webroot-src. */
...
return { countChanged, countEnabled, countHighRiskEnabled, loadJson, loadUserConfig, mergeConfig, readGeneratedSystemProp, saveConfig };
})();
...
(() => {
const { MODULE_DIR, STATE_DIR, exec, readText, writeBase64 } = __bridge;
const { countChanged, countEnabled, countHighRiskEnabled, loadJson, loadUserConfig, mergeConfig, readGeneratedSystemProp, saveConfig } = __config;
