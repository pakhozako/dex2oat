...
- 模块管理器中显示绿色、黄色、红色方块状态提示。
- 卸载后恢复模块内改动，不替换系统文件。

## 适合场景

- 想减少后台 dex2oat 编译带来的发热和耗电。
- 想控制安装、OTA、后台维护时的 dexopt 策略。
- 想通过 WebUI 直观看到当前编译策略是否生效。
- 想保留高级配置能力，但不想手动维护大量属性文件。

## 使用方式

1. 下载发布包 `Dex2oat-Lock-v3.2-release.zip`。
